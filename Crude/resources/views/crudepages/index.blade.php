                        ...
                        <tbody>
                          ...
                          @foreach($Data as $data)
                              <tr>
                                ...
                                <td>{{$data->phone}}</td>
                                <td>
                                  <a href="/home/{{$data->id}}/view" class="btn btn-sm btn-info">View</a>
                                  <a href="/home/{{$data->id}}/edit" class="btn btn-sm btn-info">Eidt</a>
                                  <a href="/home/{{$data->id}}/delete" class="btn btn-sm btn-info">Delete</a>
                                  <div class="row d-flex">
<!--   
                                    <div class="form">
                                       <form action="/home/{{$data->id}}/view" method="post">
                                            <a href="/home/{{$data->id}}/view" class="btn btn-sm btn-info">view</a>
                                                                           </form>
                                     </div>
                                    <div class="form">
                                     ...
                                     <div class="form">
                                       <form action="/home/{{$data->id}}/delete" method="post">
                                            <a href="" class="btn btn-sm btn-info">delete</a>
                                        </form>
                                     </div>
                                  </div> -->
